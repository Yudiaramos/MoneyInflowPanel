...
# Função para preencher os campos de entrada ao selecionar uma linha
...
btn_adicionar = ttk.Button(frame_adicionar, text="Adicionar Dados", command=adicionar_dados)
...
btn_atualizar = ttk.Button(frame_botoes, text="Atualizar Dado", command=atualizar_dado)
btn_atualizar.pack(side='left', padx=5, pady=5)

btn_deletar = ttk.Button(frame_botoes, text="Deletar Dado", command=deletar_dado)
